...
export const Tracking: React.FC<TrackingProps> = ({
  ...
  const [gameState, setGameState] = useState<'SETTINGS' | 'CONDITION' | 'INSTRUCTIONS' | 'GAME'>('SETTINGS');
        ...
        <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 p-12 rounded-[3rem] space-y-8">
          ...
          <div className="space-y-4">
            ...
            <input
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl p-4 focus:outline-none focus:border-amber-500 transition-colors text-xl font-bold text-center"
          ...
          <button
            ...
            className="w-full bg-amber-600 hover:bg-amber-500 text-white font-black py-5 rounded-2xl transition-all flex items-center justify-center gap-3 text-lg group"
          >
            Start Game
