...
export const DotMemory: React.FC<DotMemoryProps> = ({
  ...
  const [gameState, setGameState] = useState<'SETTINGS' | 'CONDITION' | 'INSTRUCTIONS' | 'PRE_START' | 'COUNTDOWN' | 'SHOW_DOTS' | 'PLACE_DOTS' | 'FINISHING' | 'SHOW_SOLUTION' | 'SHOW_SOLUTION_HIDE_DOTS'>('SETTINGS');
        ...
        <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 p-12 rounded-[3rem] space-y-8">
          ...
          <div className="space-y-4">
            ...
            <input
              ...
              className="w-full bg-zinc-950 border border-zinc-800 rounded-2xl p-4 focus:outline-none focus:border-emerald-500 transition-colors text-xl font-bold text-center"
          ...
          <button
            ...
            className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-black py-5 rounded-2xl transition-all flex items-center justify-center gap-3 text-lg group"
          >
            Start Game
